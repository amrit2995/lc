...
__all__ = ["OrderLevelWithRevenue"]

class OrderLevelWithRevenue(
    ExtraEntityMixins, 
    JobStatusReport, 
    BaseReportEntity
    ):
    ...
    def custom_process_report(cls, df: pd.DataFrame, *args, **kwargs) -> pd.DataFrame:
        ...
        df["Column.TOTAL_LINE_ITEM_LEVEL_ALL_REVENUE"] = df["Column.TOTAL_LINE_ITEM_LEVEL_ALL_REVENUE"] / 1000000
        return df
...
from kuber_data_sync.model.models import CustomeTargetingKeyModel
...
__all__ = ["CustomTargetingKey"]

class CustomTargetingKey(BaseEntity):

    gam_service_name = 'CustomTargetingService'
    gam_method_name = 'getCustomTargetingKeysByStatement'
    mongo_collection_name = "customTargetingKeys"
    model = CustomeTargetingKeyModel
